...
const CREDITS = [
    {
        ...
        rows: [['Davood Noori', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Davood Noori', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Davood Noori', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2022 Davood Noori'}
        >
            <div
